# ====================================================================
# DEPLOY BRD FROM HISTORY LAMBDA
# Deploys the BRD from history Lambda function to AWS
# ====================================================================

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Deploy BRD from History Lambda" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$FUNCTION_NAME = "brd_from_history_lambda"
$PACKAGE_DIR = "lambda_brd_history_package"
$ZIP_FILE = "lambda_brd_history_package.zip"
...
if ($updateMode) {
    ...
    Write-Host "    --handler lambda_brd_from_history.lambda_handler \" -ForegroundColor Cyan
