...
class RAGService:
    ...
    async def query_with_rag(
        ...
        """
        try:
            # Step 1 & 2: Perform semantic search
            logger.info(f"Performing semantic search for: {user_query[:50]}...")
            ...
            for result in results:
                # Add to context (already includes surrounding chunks if requested)
