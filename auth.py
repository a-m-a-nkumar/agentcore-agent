...
GROUP_MODULE_MAP = {
    BUSINESS_GROUP_OID: ["brd", "confluence", "jira", "figma", "brd-sync", "pr-sync", "jira-sync"],
    TECH_GROUP_OID: ["design", "figma", "pair-programming", "testing", "confluence", "jira", "harness", "brd-sync", "pr-sync", "jira-sync"],
}

ALL_MODULES = {"brd", "confluence", "jira", "design", "figma", "pair-programming", "testing", "harness", "brd-sync", "pr-sync", "jira-sync"}
